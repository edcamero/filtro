 ...
 * @author USUARIO
 */
public class TecnicoLista extends javax.swing.JInternalFrame {

    static TecnicoLista tecnicoLista;

    /**
     * Creates new form TecnicoLista
     */
    public TecnicoLista() {
        initComponents();
    }

    public static TecnicoLista getEstancia() {
        if (tecnicoLista == null) {
            tecnicoLista = new TecnicoLista();
        }
        return tecnicoLista;
    }
