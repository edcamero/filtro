...
public class MantenimientoEquipo implements java.io.Serializable {
    ...
    private ArrayList<RepuestoMante> repuestos = new ArrayList<RepuestoMante>(0);
    ...
    public ArrayList<RepuestoMante> getRepuestos() {
        return repuestos;
    }

    public void setRepuestos(ArrayList<RepuestoMante> repuestos) {
    ...
    public void agregarRepuestos(Repuesto repuesto, int cantidad) {
        RepuestoMante respMant = new RepuestoMante(this, repuesto, cantidad);
    ...
    public void eliminarRepuesto(int index) {
        RepuestoMante respuestoMant=this.repuestos.remove(index);
    ...
    public String misRepuestos() {
        String respuesta = "";
        for (RepuestoMante repuesto : repuestos) {
